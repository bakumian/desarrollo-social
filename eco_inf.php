  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-link"></i> <span>Social</span></a></li>
        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Economia Informal</span>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Economia informal</li>
      </ol>
    </section>
